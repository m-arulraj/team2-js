...
<body class="w3-theme-l5">
	...
	<div class="w3-container w3-content w3-center"
		...
		<div class="w3-row w3-center" align="center">
			...
			<div align="center">
				<!-- Middle Column -->
				<div class="w3-col m7  w3-card w3-round w3-white w3-center"
					align="center" style="margin-left: 20%">
					...
					<div class=" w3-bar w3-block ">
						<button class="w3-bar-item w3-button"
							onclick="registration('jobSeeker')">Job seeker</button>
						<button class="w3-bar-item w3-button"
							onclick="registration('employer')">Employer</button>
					...
					<div id="employer" class="w3-container registration">
						...
						<form action="/api/registration/employer" method="post">
							<div class="container">
								...
								<button type="submit" class="registerbtn">Create
									Account</button>
							</div>

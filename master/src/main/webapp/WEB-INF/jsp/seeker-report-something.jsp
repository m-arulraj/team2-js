...
<body class="w3-theme-l5" onload="startTime()">
	...
	<div class="w3-top">
		<div class="w3-bar w3-theme-d2 w3-left-align w3-large">
			<a
				...
				class="fa fa-home w3-margin-right"></i>Seeker Home</a> <a href="profile"
				...
				title="Applied Jobs"><i class='fab fa-black-tie'
				style='font-size: 20px'></i> &nbsp;&nbsp;Applied Jobs</a> <a
				href="report"
	...
	<div id="navDemo"
		...
		<a href="profile" class="w3-bar-item w3-button w3-padding-large">Update
			...
			href="jobs" class="w3-bar-item w3-button w3-padding-large">Applied
		...
		<div class="w3-row">
			...
			<div class="w3-col m7">
				<div class="w3-container w3-card w3-white w3-round w3-margin">
					<br>
					<h3 class="w3-center w3-blue w3-xxlarge ">Report Something</h3>
					<hr class="w3-clear">
					<br>
						<div class="w3-container ">
							<form action="#">
							...
							<br>
							<center><input type="submit" class="w3-button w3-blue w3-center" value="Send Feedback"></center>
						</form>

...
<body class="w3-theme-l5" onload="startTime()">
	...
	<div id="navDemo"
		...
		<a href="employer/profile"
			...
			href="employer/jobs" class="w3-bar-item w3-button w3-padding-large">Posted Jobs</a>
			 <a href="employer/profile"
		...
		<div class="w3-row">
			...
			<div class="w3-col m3">
				...
				<div class="w3-card w3-round w3-white">
					<div class="w3-container">
						...
						<a href="employer/profile" style="width: 90%"
			...
			<div class="w3-col m7">
				<div class="w3-container w3-card w3-white w3-round w3-margin">
					<br>
					<h3 class="w3-center w3-dark-gray w3-xxlarge ">Employer Home</h3>
					<hr class="w3-clear">
					<br> <br>
				</div>

...
<body class="w3-theme-l5" onload="startTime()">
	...
	<div class="w3-top">
		<div class="w3-bar w3-theme-d2 w3-left-align w3-large">
			<a
				...
				title="jobs"><i class='fab fa-black-tie' style='font-size: 20px'></i>
				&nbsp;&nbsp;Applied Jobs</a> <a href="seeker/report"
	...
	<div id="navDemo"
		...
		<a href="seeker/profile"
			...
			href="seeker/jobs" class="w3-bar-item w3-button w3-padding-large">Applied
			Jobs</a> <a href="admin/profile"
			class="w3-bar-item w3-button w3-padding-large">Report Something</a> <a
		...
		<div class="w3-row">
			...
			<div class="w3-col m7">
				<div class="w3-container w3-card w3-white w3-round w3-margin">
					<br>
					<h3 class="w3-center w3-dark-gray w3-xxlarge ">Seeker Home</h3>
					<hr class="w3-clear">
					<br> <br>
				</div>

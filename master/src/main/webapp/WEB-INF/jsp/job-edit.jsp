		...
		<div class="w3-row">
			...
			<div class="w3-col m7">
				...
				<div class="w3-container ">
							...
							<form:form action="updatedjobs" method="post"
								...
								<div class="container">
									<div class="w3-row ">
										...
										<form:input class="w3-input w3-border w3-round-large" placeholder="${postedJobList.jobTitle }"
											name="JobTitle" type="text" path="jobTitle" />
									</div>
									<br>
									<div class=" w3-row">
										<label>Job Id:</label>
										<form:input class="w3-input w3-border w3-round-large" placeholder="${postedJobList.jobId}"
											name="JobId" type="text" path="jobId" />
									</div>
									<br>
									<div class="w3-row ">

										<label>Job Type:</label>
										<form:input class="w3-input w3-border w3-round-large" placeholder="${postedJobList.jobType }"
											name="JobType" type="text" path="jobType" />
									</div>
									<br>
									<div class=" w3-row">
										<label>JobDescription:</label>
										<form:input class="w3-input w3-border w3-round-large" placeholder="${postedJobList.jobDescription}"
											name="jobDescription" type="text" path="jobDescription" />
									</div>
									<br>
									<div class="w3-row ">

										<label>Required Skills:</label>
										<form:input class="w3-input w3-border w3-round-large"  placeholder="${postedJobList.requiredSkills }"
											name="requiredSkills" type="text" path="requiredSkills" />
									</div>
									<br>
									<div class="w3-row ">

										<label>Job Location:</label>
										<form:input class="w3-input w3-border w3-round-large" placeholder="${postedJobList.jobLocation}"
											name="requiredSkills" type="text" path="jobLocation" />
									</div>
									<br>
									<div class=" w3-row">
										<label>Number of vacancies:</label>
										<form:input class="w3-input w3-border w3-round-large" placeholder="${postedJobList.numberOfVacancies}"
											name="numberOfVacancies" type="text" path="numberOfVacancies" />
									</div>
									<br>
									<div class="w3-row ">

										<label>Salary:</label>
										<form:input class="w3-input w3-border w3-round-large" placeholder="${postedJobList.salary}"
											name="salary" type="text" path="salary" />
									</div>
									<form:hidden path="id"
									value="${postedJobList.id}" />
									<br>
									<div class="w3-center">

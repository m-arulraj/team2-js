		...
		<div class="w3-row">
			...
			<div class="w3-col m9">
				...
				<div class="w3-container w3-card w3-white w3-round w3-margin">
					<div class="w3-container">
						<h2 class="w3-center w3-xxlarge w3-indigo">Reports /
							Feedback</h2>

						<ul class="w3-ul w3-border">
							<c:forEach var="feedback" items="${repoList}">
								<li class="w3-bar"><span
									onclick="this.parentElement.style.display='none'"
									class="w3-bar-item w3-button w3-white w3-xlarge w3-right">×</span>
									
									<div class="w3-bar-item">
									UserName: <span class="w3-large">${feedback.getUserName() }</span><br> 
									Job Id: <span class="w3-text-red">${feedback.getJobId() }</span> <br>
									Message: <span class="w3-text-red">${feedback.getMessage() }</span>
									</div></li>
							</c:forEach>
						</ul>
						<br>

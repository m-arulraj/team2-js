					...
					<div class="content">
						...
						<form action="/postjob"  >
							<div class="container" >
								...
								<%-- <label for="Job Title"><b>Job Title</b></label><br>
								 method="post" modelAttribute ="postedjobs"
								
								<form:input type="text" placeholder="EnterJob Title"
									name="JobTitle" path="postedjobs.jobTitle"/>
								<br> <label for="Job Id"><b>JobId</b></label><br>
								<form:input type="text" placeholder="Enter Job id"
									name="jobId" path="postedjobs.jobId"/>
								<br>
								<label for="Job Type"><b>JobType</b></label><br>
								<form:input type="text" placeholder="Enter Job type"
									name="jobType" path="postedjobs.jobType"/>
								<br>
								<label for="Job Description"><b>JobDescription</b></label><br>
								<form:input type="text" placeholder="Enter Job Description"
									name="jobDescription" path="postedjobs.jobDescription"/>
								<br>
								<label for="requiredSkills"><b>Required Skills</b></label><br>
								<form:input type="text" placeholder="Enter Required Skills"
									name="requiredSkills" path="postedjobs.requiredSkills"/>
								<br>
								<label for="No of vacencies"><b>Number of vacancies</b></label><br>
								<form:input type="number" placeholder="Enter Number of vacencies"
									name="numberOfVacancies" path="postedjobs.numberOfVacancies"/>
								<br>
								<label for="Salary"><b>Salary</b></label><br>
								<form:input type="text" placeholder="Enter Salary"
									name="salary" path="postedjobs.salary"/>
								<br>
								<button type="submit" class="postjobbtn">Create
									Account</button>
							</div>
						</form:form> --%>
						<label for="Job Title"><b>Job Title</b></label><br>
								<input type="text" placeholder="EnterJob Title"
									name="JobTitle" path="postedjobs.jobTitle"/>
								<br> <label for="Job Id"><b>JobId</b></label><br>
								...
								<br>
								<label for="No of vacencies"><b>Number of vacancies</b></label><br>
								<input type="number" placeholder="Enter Number of vacencies"
									name="numberOfVacancies" path="postedjobs.numberOfVacancies"/>
								<br>
								<label for="Salary"><b>Salary</b></label><br>
					...
					<ul class="w3-ul w3-border">
						<c:forEach items="${postedjobList}" var="postedjobs">
							...
							<div class="w3-bar-item">
								<span class="w3-large">${postedjobs}

</span><br> <span>${postedjobs}</span>
							</div></li>
						</c:forEach>						
					</ul>
					<br>
